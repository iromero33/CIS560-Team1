...
{
    internal class GetSongsWithMostSpotifyListensPerMonthDataDelegate : DataReaderDelegate<IReadOnlyList<Song>>
    {
        public GetSongsWithMostSpotifyListensPerMonthDataDelegate()
            : base("Music.GetSongsWithMostSpotifyListensPerMonth")
        {
        }
