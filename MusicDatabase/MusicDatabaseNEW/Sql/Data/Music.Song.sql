...
(
    ...
    (
        VALUES
         ...
         (N'NOT SOBER (feat. Polo G & Stunna Gambino)', N'The Kid LAROI', N'F*CK LOVE 3+: OVER YOU',  N'No Genre Provided', 11869336),
         ...
         (N'Build a Bitch', N'Bella Poarch', N'Build a Bitch - Single',  N'No Genre Provided', 9841998),
         (N'Nicky Jam: Bzrp Music Sessions, Vol. 41', N'Bizarrap, Nicky Jam', N'Nicky Jam: Bzrp Music Sessions, Vol. 41 - Single',  N'argentine hip hop, pop venezolano, trap argentino, trap latino', 9799701),  (N'Tiroteo - Remix', N'Marc Segui­, Rauw Alejandro, Pol Granch', N'Tiroteo - Remix - Single',  N'No Genre Provided', 9781153),
         ...
         (N'Meu Pedaco de Pecado', N'Joao Gomes', N'Meu PedaÃ§o de Pecado - Single',  N'No Genre Provided', 9206366),
         ...
         (N'No Me Conocen (Remix) [con DUKI, Rei & Tiago PZK]', N'BANDIDO', N'No Me Conocen (Remix) [con DUKI, Rei & Tiago PZK] - Single',  N'No Genre Provided', 6709106),
         ...
         (N'Paris', N'Ingratax', N'Pari­s - Single',  N'No Genre Provided', 6584896),
         (N'lovely (with Khalid)', N'Billie Eilish', N'lovely (with Khalid) - Single',  N'electropop, pop', 6569547),
         (N'Sunflower - Spider-Man: Into the Spider-Verse', N'Post Malone, Swae Lee', N'Sunflower - Spider-Man: Into the Spider-Verse - Single',  N'No Genre Provided', 6546948),
         ...
         (N'Aquelas Coisas', N'Joao Gomes', N'Eu Tenho A Senha!',  N'No Genre Provided', 6012839),
